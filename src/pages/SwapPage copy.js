  ...
  return (
    <div ref={ref} className="relative w-full">
      <button
        ...
        className="w-full flex items-center gap-2 bg-black p-3 rounded-lg text-white"
      >
        {selectedToken ? (
          <>
      ...
      {open && (
        <div className="absolute z-10 mt-1 w-full bg-black rounded-lg shadow-lg max-h-60 overflow-auto">
          {Object.entries(tokens).map(([symbol, token]) => (
            <div
              ...
              className="flex items-center gap-2 px-3 py-2 cursor-pointer hover:bg-purple-700"
            >
              {token.icon && (
...
export default function SwapPage() {
  ...
  />
      ...
      <div className="max-w-xl mx-auto bg-purple-900 p-6 rounded-xl shadow-lg border border-gray-700 space-y-4">
        <div>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <input
              ...
              className="flex-1 text-right bg-black p-3 rounded-lg text-white placeholder-gray-500 outline-none"
            />
          </div>
          <input
            type="text"
            ...
            className="w-full bg-black p-2 rounded-md text-sm text-gray-300"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full mt-2 bg-black p-2 rounded-md text-sm text-gray-300"
          />
        </div>
        ...
        <button
          ...
          className="w-full mt-4 bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-lg text-lg font-semibold disabled:bg-purple-600"
        >
