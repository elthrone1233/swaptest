  ...
  return (
    <div className="bg-black text-white min-h-screen p-6">
      <header className="flex justify-between items-center mb-6">
        ...
        <button onClick={connectWallet} className="bg-purple-600 px-4 py-2 rounded hover:bg-purple-700">
  ...
  <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">
    ...
    All data is read-only and securely accessed on-chain. No NFTs are ever moved or modified.
      ...
      <div className="flex flex-col md:flex-row gap-4  ">
        ...
        />
        <button onClick={() => analyzeNFT()} className="bg-purple-600 px-6 py-3 rounded hover:bg-purple-700">
          AnalyzeNFT
        </button>
      </div>
      ...
      {showModal && nftData && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
          <div className="bg-purple-900 p-6 rounded-lg max-w-xl w-full relative">
            ...
            <div className="mt-4 p-3 bg-black rounded text-green-400 font-mono">
              {typedAiComment}
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {featuredData.map((nft) => (
          <div
            key={nft.address}
            className="bg-black rounded p-4 cursor-pointer hover:bg-purple-700 transition"
