...
function RugCheckPopup() {
  ...
  return (
    <div className="button-30 fixed top-10 left-1/2 transform -translate-x-1/2 z-50 max-w-md w-full p-6 bg-zinc-900 text-white rounded-2xl shadow-xl border border-zinc-700">
