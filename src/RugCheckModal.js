...
function RugCheckPopup() {
  ...
  return (
    <div className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50 max-w-md w-full p-6 bg-zinc-900 text-white rounded-2xl shadow-xl border border-zinc-700">
