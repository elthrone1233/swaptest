    ...
    <div className="p-6 rounded-xl mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {coins.map((token) => (
            <div
              ...
              className="bg-black p-4 rounded-lg hover:bg-purple-700 cursor-pointer transition text-center"
            >
              <img
                src={token.thumb}
                alt={token.name}
      ...
      {selectedToken && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-purple-900 text-white p-6 rounded-xl max-w-lg w-full relative shadow-lg border border-gray-700">
            <button
              onClick={() => {
            ...
            <div className="mt-6 bg-black p-4 rounded-md text-sm font-mono min-h-[80px]">
